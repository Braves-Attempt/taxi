...
class TB:
    def __init__(self, dut):
        ...
        cocotb.start_soon(Clock(dut.qsfp_1_mgt_refclk_p, 6.206, units="ns").start())
        ...
        dut.qsfp_1_intr_n.setimmediatevalue(0)
...
def test_fpga_core(request, mac_data_w):
    ...
    verilog_sources = [
        ...
        os.path.join(taxi_src_dir, "io", "rtl", "taxi_led_sreg.sv"),
    ]
